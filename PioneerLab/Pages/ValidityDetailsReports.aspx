<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="ValidityDetailsReports.aspx.cs" Inherits="PioneerLab.Pages.ValidityDetailsReports" %>
                        ...
                        <tr>
                            ...
                            <td style="width: 250px">
                                <dx:ASPxComboBox ID="cmbValidityName" runat="server" ValueField="ValidityID" TextField="ValidityName" DropDownStyle="DropDownList" Width="250"
                                                        DataSourceID="ValidityListDS" ValueType="System.Int32">
                            ...
                            <td style="width: 200px">
                                <dx:ASPxComboBox ID="cmbStatus" runat="server" ValueType="System.String" DisplayFormatString="{0}" 
