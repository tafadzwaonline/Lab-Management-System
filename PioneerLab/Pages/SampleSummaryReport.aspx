<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="SampleSummaryReport.aspx.cs" Inherits="PioneerLab.Pages.Reports.SampleSummaryReport" %>
            ...
            <div id="divValidityDetails" runat="server" style="clear: left; ">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 200px">
                            <dx:ASPxTextBox ID="tbSampleNo" runat="server">
                            </dx:ASPxTextBox>
                        </td>
                         <td style="width: 120px">
